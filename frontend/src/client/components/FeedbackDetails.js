    ...
    {editMode ? (
      ...
      <div>
        ...
        <label>User Name: {userDetails}</label>
          ...
          <button onClick={() => setEditMode(true)} style={{width: '250px', margin: '0 auto', display: 'block'}}>Update</button><br/>
          <button onClick={handleDelete} style={{width: '250px', margin: '0 auto', display: 'block'}}>Delete</button>
        </div>
      </div>
    )}
  </div>
